...
$("#submit-form").submit((e)=>{
    e.preventDefault()
    $.ajax({
        url:"https://script.google.com/macros/s/AKfycbzh2f0ANktZkmmIFnWCKFIzJMb6-EeSaM3NnEOmg_lTwqR3qzqFCzm-iJCobW7H_5RrUg/exec",
  ...
  if(nameField.length == 0){
{
   ...
   if(!nameField.match(/^[A-Za-z]*\s{1}[A-Za-z]+$/) ){
      ...
      return false;
       ...
       nameError.innerHTML='<i class="fa fa-check text-success"></i>';
       return true;
...
function validateEmail(){
 ...
 if(!emailField.match(/^[A-Za-z\._\-0-9]*[@][A-Za-z]*[\.][a-z]{2,4}$/)){
  ...
  emailError.innerHTML='<i class="fa fa-check text-success"></i>';
  return true;
}
}
function validateSubject(){
  ...
  return false;
      ...
      subjError.innerHTML ='<i class="fa fa-check text-success"></i>';
      return true;
  }
...
function validateMessage(){
  ...
  return false;
      ...
      msgError.innerHTML ='<i class="fa fa-check text-success"></i>';
      return true;
  }
